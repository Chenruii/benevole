...
---*/
require_once 'BaseLayerX.php';
// Assurons nous que nous avons la posibilité d'utiliser MySQL
if (!function_exists('mysqli_connect'))
	exit('PHP ne support pas MySQL (mysqli). MySQL (mysqli) est requis pour utiliser les bases de donées MySQL (mysqli) néccessaire au fonctionnement du Mibbo. Consultez la documentation de PHP pour plus d\'informations.');

class MIB_DbLayerX extends BaseLayerX
{
	var $prefix;
	var $link_id;
	var $query_result;
